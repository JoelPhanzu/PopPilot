...
SUITES = [
    ...
    ("test_budget_api.py",         "Suivi budgetaire (GET /budget)"),
    ("test_configuration_api.py",  "Configuration (taux, provisions, agences)"),
    ...
    ("test_archives.py",           "Archives (bibliotheque, edition, series)"),
